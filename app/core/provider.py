...
# SERVICE PROVIDERS WITHOUT DAO


_module_service = ModulesService()
_claspyml_service = ClaspyMLService()
...
def get_claspyml_service() -> ClaspyMLService:
    return _claspyml_service
