...
def load_claspy_plugin(plugin_name: str, module_service: Annotated[IModuleService, Depends(
        lambda: ServiceProvider.get_module_service())]):
...
def unload_claspy_plugin(plugin_name: str, module_service: Annotated[IModuleService, Depends(
        lambda: ServiceProvider.get_module_service())]):
