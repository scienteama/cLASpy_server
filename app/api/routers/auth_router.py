...
async def logout(res: Response, auth_service: Annotated[AuthService,
...
async def check_session(request: Request, auth_service: Annotated[AuthService, Depends(get_auth_service)],):
